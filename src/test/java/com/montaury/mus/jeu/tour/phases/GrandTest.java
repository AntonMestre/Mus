...
class GrandTest {
  ...
  void devrait_faire_gagner_le_joueur_esku_s_il_a_la_plus_grande_carte() {
    ...
    Joueur joueurPriorite2 = unJoueurAvec(main(Carte.AS_BATON, Carte.CINQ_PIECE, Carte.TROIS_BATON, Carte.SIX_COUPE));
    Joueur joueurPriorite3 = unJoueurAvec(main(Carte.AS_BATON, Carte.CINQ_PIECE, Carte.CAVALIER_BATON, Carte.SIX_COUPE));
    Joueur joueurZaku = unJoueurAvec(main(Carte.DEUX_BATON, Carte.TROIS_PIECE, Carte.SEPT_BATON, Carte.AS_PIECE));

    Joueur vainqueur = new Grand().meilleurParmi(new Opposants(joueurEsku, joueurPriorite2, joueurPriorite3, joueurZaku));
  ...
  void devrait_faire_gagner_le_joueur_zaku_s_il_a_la_plus_grande_carte() {
    ...
    Joueur joueurPriorite2 = unJoueurAvec(main(Carte.DEUX_BATON, Carte.SEPT_PIECE, Carte.TROIS_BATON, Carte.SIX_COUPE));
    Joueur joueurPriorite3 = unJoueurAvec(main(Carte.AS_BATON, Carte.CINQ_PIECE, Carte.SIX_BATON, Carte.SIX_COUPE));
  ...
  void devrait_faire_gagner_le_joueur_qui_a_la_seconde_plus_grande_carte_si_la_premiere_est_egale() {
    ...
    Joueur joueurPriorite2 = unJoueurAvec(main(Carte.AS_BATON, Carte.DEUX_PIECE, Carte.TROIS_BATON, Carte.QUATRE_COUPE));
    Joueur joueurPriorite3 = unJoueurAvec(main(Carte.AS_BATON, Carte.QUATRE_PIECE, Carte.TROIS_BATON, Carte.DEUX_COUPE));
